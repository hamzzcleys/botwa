       	...
       	case 'upgrade':
               switch (_type) {
               	case 'pickaxe':
                        ...
                        if (global.db.data.users[m.sender].money > Upickaxe) {
                   ...
                   case 'fishingrod':
                        ...
                        if (global.db.data.users[m.sender].money > Ufishing) {
                            global.db.data.users[m.sender].fishingroddurability += 500
                            global.db.data.users[m.sender].money -= Ufishing * 1
                            conn.reply(m.chat, `Succes menambah durability fishingrod seharga ${Ufishing} money`, m)
                        } else conn.reply(m.chat, `uang mu tidak cukup untuk menambah durability fishingrod seharga ${Ufishing} money`, m)
            ...
            case 'buy':
                ...
                case 'pickaxe':
                  ...
                  case 'fishingrod':
                        ...
                        if (global.db.data.users[m.sender].money > fishingrod) {
