...
let peli = await (await fetch('https://telegra.ph/file/1d4ab826d9d3e1bf2b845.jpg')).buffer()
let ye = await (await fetch('https://telegra.ph/file/1d4ab826d9d3e1bf2b845.jpg')).buffer()
  let _return
  let _syntax = ''
...
orderTitle: 'B',
sellerJid: '6285850961679@s.whatsapp.net',
thumbnail: ye
